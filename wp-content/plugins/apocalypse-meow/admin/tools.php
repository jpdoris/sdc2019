...
$data = array(
	...
	'modals'=>array(
		'passwords-md5'=>array(
			sprintf(
				__('For historical reasons, WordPress has retained backward compatibility with the outdated %s hashing algorithm. Should a hacker obtain a copy of your % table, any user with an MD5-hashed password could be in serious trouble.', 'apocalypse-meow'),
