...
class admin {
	...
	public static function pro_page() {
		require \MEOW_PLUGIN_DIR . 'admin/pro.php';
	}
	...
	public static function plugin_action_links($links) {
		...
		// Pro.
			...
			$links[] = '<a href="' . \esc_url(\admin_url('admin.php?page=meow-pro')) . '">' . \__('Enter License', 'apocalypse-meow') . '</a>';
		}
