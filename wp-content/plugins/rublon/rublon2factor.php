<?php
/*
Plugin Name: Rublon Two-Factor Authentication (2FA)
Text Domain: rublon
Plugin URI: http://wordpress.org/plugins/rublon/
Description: Rublon is cloud-based cybersecurity software that helps companies protect their users, data and applications by providing trusted access via easy-to-use two-factor authentication.
Version: 4.0.0
Author: Rublon
