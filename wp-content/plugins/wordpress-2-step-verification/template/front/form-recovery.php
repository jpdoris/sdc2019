...
<div class="form">
    <form name="recoverForm" method="post" action="" id="recovery-form">
        ...
        <div class="desc">
            <ol>
                <li><b><?php _e('Download','wordpress-2-step-verification');?></b> <input class="link" type="submit" name="wp2sv_recovery_download" value="<?php _e('this HTML verification file','wordpress-2-step-verification');?>"> <span class="help">[<?php $this->recovery->fileName();?>]</span></li>
